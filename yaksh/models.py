...
class Quiz(models.Model):
    ...
    def create_demo_quiz(self, user):
        demo_quiz = Quiz.objects.create(
            ...
            description='Halo Demo quiz', pass_criteria=0,
    ...
    def create_demo(self, user):
        ...
        if not course:
            ...
            learning_module = LearningModule.objects.create(
                name="Demo Category", description="<center>Demo Category</center>",
                creator=user, html_data="<center>Demo Category</center>",
                check_prerequisite=False
                )
